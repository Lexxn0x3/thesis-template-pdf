...
\newcommand{\titel}{Entwicklung eines Tools zur Optimierung von WLAN-Netzwerken in Unternehmen}
\newcommand{\artderarbeit}{Exposé Bachelorarbeit}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{Robin Rosner}
\newcommand{\studiengang}{Informatik}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{362\,25303}
\newcommand{\erstgutachter}{}
\newcommand{\zweitgutachter}{}
\newcommand{\betreuer}{Jannick ....}
\newcommand{\unternehmen}{Siemens GmbH}
...
%disable chapter numbers on sections
...
\mainmatter
\include{content/content}% remove if not needed
\appendix
